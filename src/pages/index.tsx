  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="ESG Reporting - Your one-stop platform for comprehensive Global ESG Reporting. Empower your business with sustainability insights."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1625244514957-a8cdb2b7df0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxFU0d8ZW58MHx8fHwxNjk1NzA5MDA3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@thefloridaguidebook?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Florida-Guidebook.com`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`ESG Reporting - Your one-stop platform for comprehensive Global ESG Reporting. Empower your business with sustainability insights.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="ESG Manager" type="esg-manager" abilities={appConfig.ownerAbilities} />
