...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'ESG Report Submission.create': {
    roles: ['organization-owner', 'esg-manager', 'compliance-officer'],
    key: 'ESG Report',
    tenantPath: [],
    userPath: [],
  },
  'Compliance Issue Raised.create': {
    roles: ['organization-owner', 'esg-manager'],
    key: 'Compliance Issue',
    tenantPath: [],
    userPath: [],
  },
  'Customer Feedback Submission.create': {
    roles: ['organization-owner', 'esg-manager', 'compliance-officer', 'data-analyst'],
...
const ownerRoles: string[] = ['esg-manager'];
